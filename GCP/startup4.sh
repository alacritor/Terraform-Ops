...
cat <<EOF > /var/www/html/index.html
<html><body>
<h2>I need this, I crave this, I DESERVE THIS!!!</h2>
<h3>Big Bazongas feed my hunga!</h3>
<iframe src="https://giphy.com/embed/NqTEcXRkkyh5m" width="281" height="480" style="" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/sexy-girl-NqTEcXRkkyh5m">via GIPHY</a></p>
