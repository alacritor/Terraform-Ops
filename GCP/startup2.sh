...
cat <<EOF > /var/www/html/index.html
<html><body>
<h2>I came here to GCP Class 6.5 to Chew Bubble Gum and Kick Ass.</h2>
<h3>and as the gif says...</h3>
<iframe src="https://giphy.com/embed/s2nfjfOCPk1So" width="480" height="359" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/john-carpenter-they-live-rowdy-roddy-piper-s2nfjfOCPk1So">via GIPHY</a></p>
<p><b>Instance Name:</b> $(hostname -f)</p>
<p><b>Instance Private IP Address: </b> $local_ipv4</p>
<p><b>Zone: </b> $zone</p>
<p><b>Project ID:</b> $project_id</p>
